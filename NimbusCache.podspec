...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "Soar to new speeds with NimbusCache — a powerful caching framework inspired by the legendary Nimbus 2000!"
  ...
  # Or just: spec.author    = "Vijay Subramani"
  # spec.authors            = { "Vijay Subramani" => "vijaysubramani.ios.dev@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Vijay Subramani"
  ...
  spec.source       = { :git => "https://github.com/vijay-subramani/NimbusCache.git", :tag => "#{spec.version}" }
